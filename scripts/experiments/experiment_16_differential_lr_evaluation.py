"""
Experiment 16 -- Deep Learning, crop-based heatmap model evaluation.
...
Run from the repo root with:
    uv run python scripts/experiments/experiment_16_differential_lr_evaluation.py
"""
...
RESULTS_CSV = "experiment_16_results.csv"
TOLERANCE_PCT = 5.0
...
def main() -> None:
    ...
    with mlflow.start_run(run_name="exp16_differential_lr_evaluation"):
