"""
Experiment 18 -- Deep Learning, crop-based heatmap model evaluation.
...
Run from the repo root with:
    uv run python scripts/experiments/experiment_18_reading_aware_evaluation.py
"""
...
RESULTS_CSV = "experiment_18_results.csv"
TOLERANCE_PCT = 5.0
...
def main() -> None:
    ...
    with mlflow.start_run(run_name="exp18_reading_aware_evaluation"):
