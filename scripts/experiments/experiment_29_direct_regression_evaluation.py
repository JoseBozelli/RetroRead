"""
Experiment 29 -- Direct end-to-end regression evaluation.

Run from the repo root with:
    uv run python scripts/experiments/experiment_29_direct_regression_evaluation.py
"""
...
from retroread.direct_regression_dataset import PREPROCESS
...
RESULTS_CSV = "experiment_29_results.csv"
TOLERANCE_PCT = 5.0
...
def main() -> None:
    ...
    model = DirectRegressionModel(freeze_backbone=True)
    ...
    with torch.no_grad():
        for reading in candidates:
            ...
            norm_position = model(input_tensor)[0, 0].item()
            ...
            predicted = min_value + norm_position * scale_range
    ...
    with mlflow.start_run(run_name="exp29_direct_regression_evaluation"):
    ...
    print(f"{'':20} {'Direct Regr.':>12} {'Classical':>12}")
